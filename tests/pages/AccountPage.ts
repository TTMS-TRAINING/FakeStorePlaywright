...
export class AccountPage {
  private page: Page; // Zmienna page jest zdefiniowana jako prywatne pole
  ...
  constructor(page: Page) {
    this.page = page; // Inicjalizacja pola page
  ...
  async register(account: { email: string; registerPassword: string }) {
